...
async function FindSingleTestTechnique(testTechniqueId, testTechniqueData) {
  try {
    const TestTechnique = await TestTechnique.findById(
      testTechniqueId,
      testTechniqueData,
      { new: true }
    );
...
async function UpdateTestTechnique(testTechniqueId, testTechniqueData) {
  try {
    const testTechnique = await TestTechnique.findByIdAndUpdate(
      testTechniqueId,
      testTechniqueData,
      { new: true }
    );
...
async function DeleteTestTechnique(testTechniqueId) {
  try {
    const testTechnique = await TestTechnique.findByIdAndDelete(
      testTechniqueId
    );
    if (!testTechnique) {
      throw new Error("TestTechnique not found");
