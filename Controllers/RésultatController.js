...
const résultatService = require('../services/résultatService');
 ...
 async function getSingleRésultat (req, res, next) => {
    try {
      const résultat = await résultatService.FindSingleRésultat(req.params.résultatId);
      res.json(résultat);
    } catch (error) {
      res.send('error') ;
    }
 ...
 async function updateRésultat (req, res, next) => {
    try {
      const résultat = await résultatService.UpdateRésultat(req.params.résultatId, req.body);
      res.json(résultat);
    } catch (error) {
      res.send('error') ;
    }
 ...
 async  function deleteRésulta(req, res, next) => {
    try {
      const résultat = await résultatService.DeleteRésultat(req.params.résultatId);
      res.json(résultat);
    } catch (error) {
      res.send('error') ;
    }
