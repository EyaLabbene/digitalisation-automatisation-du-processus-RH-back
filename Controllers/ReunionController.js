...
async function getSingleReunion (req, res, next) => {
    try {
      const reunion = await reunionService.FindSingleReunion(req.params.reunionId);
      res.json(reunion);
    } catch (error) {
      res.send('error') ;
    }
 ...
 async function updateReunion (req, res, next) => {
    try {
      const reunion = await reunionService.UpdateReunion(req.params.reunionId, req.body);
      res.json(reunion);
    } catch (error) {
      res.send('error') ;
    }
